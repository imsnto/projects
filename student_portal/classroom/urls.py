...
from classroom.views import Announcement, Categories, CategoryCourses, NewCourse, Enroll, DeleteCourse, EditCourse, MyCourses, CourseDetail, Submissions, StudentSubmissions, GradeSubmission
...
urlpatterns = [
    ...
    path('<course_id>/announcement', Announcement, name='announcement'),
	#Modules
